       ...
       String nama = txtNama.getText();
        ...
        if(nama.isEmpty()){
            ...
            try {
                ...
                String q = "INSERT INTO data_perumahan (nama_perumahan, alamat, email, no_telp, pengembang, tipe_perumahan, file_brosur) VALUES (?,?,?,?,?,?,?)";
                PreparedStatement ps = c.prepareStatement(q);
                ps.setString(1, nama);
                ps.setString(2, alamat);
                ps.setString(3, email);
                ps.setString(4, telp);
                ps.setString(5, pengembang);
                ps.setString(6, tipe);
                ps.setString(7, file);
                ps.execute();
                JOptionPane.showMessageDialog(this, "Data Perumahan berhasil disimpan");
